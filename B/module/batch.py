...
from .. import userbot, Bot, OWNER
from .. import FORCESUB as fs
from B.module.pyroplug import get_bulk_msg
from B.module.helpers import get_link, screenshot
...
from A.pyfunc import video_metadata
from A.telefunc import force_sub

ft = f"To use this bot you've to join @{fs}."

batch = []

@Drone.on(events.NewMessage(incoming=True, from_users=OWNER, pattern='/cancel'))
...
@Drone.on(events.NewMessage(incoming=True, from_users=OWNER, pattern='/batch'))
